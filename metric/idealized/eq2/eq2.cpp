...
const string
IdealCPEQ2::name () const
{
    return "C/P EQ2 Approx.";
}

void
IdealCPEQ2::max (const MetricArgs &args) const
{
    ...
    metric::Summary.maxScore = cliqueConnections + 2 * coreConnections;
}

void
IdealCPEQ2::calculate (
